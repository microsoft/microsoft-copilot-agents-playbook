...
### If you already have built a declarative agent in Agents Toolkit
...
1. Use a template. Choose **Document Summary** or **Expert Answers**.
1. Modify the template as you want.
